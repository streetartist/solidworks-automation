# ISwDMConfiguration4 Interface

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration4`
![](dotnetimages/collapse.gif) ![](dotnetimages/expand.gif) ![](dotnetimages/collapse.gif) ![](dotnetimages/expand.gif) ![](dotnetimages/drpdown.gif) ![](dotnetimages/drpdown_orange.gif) ![](dotnetimages/copycode.gif) ![](dotnetimages/copycodeHighlight.gif)

|  |  |
| --- | --- |
| SOLIDWORKS Document Manager API Help | [Send comments](mailto:apihelp.feedback@3ds.com?subject=Documentation Feedback: SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration4.html) on this topic. |
| ISwDMConfiguration4 Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration4_members.md) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.md) : ISwDMConfiguration4 Interface |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface ISwDMConfiguration4     Inherits ISwDMConfiguration, ISwDMConfiguration2, ISwDMConfiguration3  ``` | |
...
| C# |  |
| --- | --- |
| ``` public interface ISwDMConfiguration4 : ISwDMConfiguration, ISwDMConfiguration2, ISwDMConfiguration3  ``` | |

| C++/CLI |  |
| --- | --- |
| ``` public interface class ISwDMConfiguration4 : public ISwDMConfiguration, ISwDMConfiguration2, ISwDMConfiguration3  ``` | |

# Visual Basic for Applications (VBA) Syntax

See [SwDMConfiguration4](swdocumentmgr~SwDMConfiguration4.md).

# Remarks

- You can access an ISwDMConfiguration4 object by calling QueryInterface on an [ISwDMConfiguration](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration.md) object in C++ or by direct assignment in Visual Basic.
- The ISwDMConfiguration object can be assigned to an ISwDMConfiguration4 variable, just like the SOLIDWORKS [IModelDoc2](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDoc2.md) object can be assigned to a SOLIDWORKS [IPartDoc](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IPartDoc.md) variable.
