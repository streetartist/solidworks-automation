# ISwDMApplication2 Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMApplication2_methods`
...
For a list of all members of this type, see [ISwDMApplication2 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMApplication2_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetDocument2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMApplication2~GetDocument2.md) | Gets the specified document from an IStream or IStorage storage. |
