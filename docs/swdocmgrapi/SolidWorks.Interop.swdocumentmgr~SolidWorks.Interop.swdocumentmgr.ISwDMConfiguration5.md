# ISwDMConfiguration5 Interface

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration5`
![](dotnetimages/collapse.gif) ![](dotnetimages/expand.gif) ![](dotnetimages/collapse.gif) ![](dotnetimages/expand.gif) ![](dotnetimages/drpdown.gif) ![](dotnetimages/drpdown_orange.gif) ![](dotnetimages/copycode.gif) ![](dotnetimages/copycodeHighlight.gif)

|  |  |
| --- | --- |
| SOLIDWORKS Document Manager API Help | [Send comments](mailto:apihelp.feedback@3ds.com?subject=Documentation Feedback: SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration5.html) on this topic. |
| ISwDMConfiguration5 Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration5_members.md) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.md) : ISwDMConfiguration5 Interface |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface ISwDMConfiguration5     Inherits ISwDMConfiguration, ISwDMConfiguration2, ISwDMConfiguration3, ISwDMConfiguration4  ``` | |
...
| C# |  |
| --- | --- |
| ``` public interface ISwDMConfiguration5 : ISwDMConfiguration, ISwDMConfiguration2, ISwDMConfiguration3, ISwDMConfiguration4  ``` | |

| C++/CLI |  |
| --- | --- |
| ``` public interface class ISwDMConfiguration5 : public ISwDMConfiguration, ISwDMConfiguration2, ISwDMConfiguration3, ISwDMConfiguration4  ``` | |

# Visual Basic for Applications (VBA) Syntax

See [SwDMConfiguration5](swdocumentmgr~SwDMConfiguration5.md).

# Remarks

- You can access an ISwDMConfiguration5 object by calling QueryInterface on an [ISwDMConfiguration](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration.md) object in C++ or by direct assignment in Visual Basic.
- The ISwDMConfiguration object can be assigned to an ISwDMConfiguration5 variable, just like the SOLIDWORKS [IModelDoc2](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDoc2.md) object can be assigned to a SOLIDWORKS [IPartDoc](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IPartDoc.md) variable.
