# ISwDMDocument30 Interface Members

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument30_members`
...
The following tables list the members exposed by [ISwDMDocument30](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument30.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [SavedInLDREditMode](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument30~SavedInLDREditMode.md) | Gets whether this document was saved in LDR Edit mode. |
