# ISwDMCutListItem3 Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMCutListItem3_methods`
...
For a list of all members of this type, see [ISwDMCutListItem3 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMCutListItem3_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [IsCustomPropertyEditable](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMCutListItem3~IsCustomPropertyEditable.md) | Gets whether the specified custom property is editable. |
