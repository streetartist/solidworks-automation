# ISwDMConfiguration5 Interface Members

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration5_members`
...
The following tables list the members exposed by [ISwDMConfiguration5](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration5.md).

# Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | [AlternateName](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration5~AlternateName.md) | Obsolete. Superseded by [ISwDMConfiguration7::AlternateName2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~AlternateName2.md). |
| Property | [Comment](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration5~Comment.md) | Obsolete. Superseded by [ISwDMConfiguration7::Comment2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~Comment2.md). |
...
|  | Name | Description |
| --- | --- | --- |
| Method | [GetCustomPropertyValues](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration5~GetCustomPropertyValues.md) | Gets the specified custom property value for this configuration. |
