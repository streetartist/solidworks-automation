# ISwDMConfiguration9 Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration9_methods`
...
For a list of all members of this type, see [ISwDMConfiguration9 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration9_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetPreviewBitmapBytes](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration9~GetPreviewBitmapBytes.md) | Gets the preview byte array for this document. |
| Method | [GetPreviewPNGBitmapBytes](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration9~GetPreviewPNGBitmapBytes.md) | Gets the preview PNG byte array for this document. |
