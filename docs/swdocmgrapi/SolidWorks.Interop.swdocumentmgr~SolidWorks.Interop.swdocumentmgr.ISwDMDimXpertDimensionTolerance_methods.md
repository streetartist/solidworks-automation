# ISwDMDimXpertDimensionTolerance Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance_methods`
...
For a list of all members of this type, see [ISwDMDimXpertDimensionTolerance members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetNominalValue](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance~GetNominalValue.md) | Gets the value of this DimXpert dimension tolerance. |
| Method | [GetPlusAndMinusTolerance](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance~GetPlusAndMinusTolerance.md) | Gets the plus and minus tolerance values for this DimXpert dimension tolerance. |
| Method | [GetUpperAndLowerLimit](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance~GetUpperAndLowerLimit.md) | Gets the upper and lower tolerance limits for this DimXpert dimension tolerance. |
