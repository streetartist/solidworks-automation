# ISwDMComponent4 Interface Members

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMComponent4_members`
...
The following tables list the members exposed by [ISwDMComponent4](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMComponent4.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetDocument2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMComponent4~GetDocument2.md) | Gets this component's document using the specified search options. |
