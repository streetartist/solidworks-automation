# ISwDMApplication5 Interface Members

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMApplication5_members`
...
The following tables list the members exposed by [ISwDMApplication5](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMApplication5.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetPreviewBitmapForAnnotationFiles](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMApplication5~GetPreviewBitmapForAnnotationFiles.md) | Gets the preview bitmap for the specified annotation file. |
