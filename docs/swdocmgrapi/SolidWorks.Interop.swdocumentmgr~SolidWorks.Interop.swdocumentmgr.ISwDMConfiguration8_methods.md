# ISwDMConfiguration8 Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration8_methods`
...
For a list of all members of this type, see [ISwDMConfiguration8 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration8_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetReferencesInformation2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration8~GetReferencesInformation2.md) | Gets the names of any reference documents, the configuration names of the references, and their suppression states. |
