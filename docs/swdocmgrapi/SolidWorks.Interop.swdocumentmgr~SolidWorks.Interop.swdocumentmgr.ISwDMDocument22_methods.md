# ISwDMDocument22 Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument22_methods`
...
For a list of all members of this type, see [ISwDMDocument22 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument22_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetFileAvgTime](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument22~GetFileAvgTime.md) | Gets the amount of time it took to open this document the last time. |
| Method | [IsCustomPropertyEditable](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument22~IsCustomPropertyEditable.md) | Gets whether the specified custom property is editable. |
