# ISwDMDocument10 Interface Properties

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10_properties`
...
|  | Name | Description |
| --- | --- | --- |
| Property | [PreviewPNGStreamName](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~PreviewPNGStreamName.md) | Gets the name of the stream for the preview bitmap (.png) of this document. |
| Property | [PreviewStreamName](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~PreviewStreamName.md) | Gets the name of the stream for the preview bitmap (.bmp) of this configuration. |
