# ISwDMConfiguration15 Interface Properties

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration15_properties`
...
For a list of all members of this type, see [ISwDMConfiguration15 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration15_members.md).

# Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | [ShowChildComponentsInBOM2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration15~ShowChildComponentsInBOM2.md) | Gets whether to show child components in the bill of materials (BOM) for this configuration. |
