# ISwDMDocument14 Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument14_methods`
...
For a list of all members of this type, see [ISwDMDocument14 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument14_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [Get3DCCGenericStreamFile](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument14~Get3DCCGenericStreamFile.md) | Exports an XML file with the 3D Content Central (3DCC) generic format configuration rules that were built into this document by the SOLIDWORKS Configuration Publisher. |
| Method | [Get3DCCStreamFile](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument14~Get3DCCStreamFile.md) | Exports an XML file with the 3D Content Central (3DCC) original format configuration rules built into this document by the SOLIDWORKS Configuration Publisher. |
