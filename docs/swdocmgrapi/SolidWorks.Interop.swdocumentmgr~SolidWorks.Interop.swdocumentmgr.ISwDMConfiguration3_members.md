# ISwDMConfiguration3 Interface Members

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration3_members`
...
The following tables list the members exposed by [ISwDMConfiguration3](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration3.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetImportedBodiesCount](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration3~GetImportedBodiesCount.md) | Gets the number of imported solid bodies in this configuration. |
| Method | [GetImportedBody](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration3~GetImportedBody.md) | Gets the imported solid body in this configuration and writes the body to the specified file in Parasolid .x\_b format. |
