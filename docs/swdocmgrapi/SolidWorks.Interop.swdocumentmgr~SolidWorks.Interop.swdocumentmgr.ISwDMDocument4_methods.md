# ISwDMDocument4 Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument4_methods`
...
For a list of all members of this type, see [ISwDMDocument4 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument4_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetActiveSheetName](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument4~GetActiveSheetName.md) | Gets the name of the active sheet in a SOLIDWORKS drawing document. |
| Method | [GetSheetCount](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument4~GetSheetCount.md) | Gets the number of sheets in the SOLIDWORKS drawing document. |
