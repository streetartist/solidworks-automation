# ISwDMDocument27 Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument27_methods`
...
For a list of all members of this type, see [ISwDMDocument27 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument27_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetExternalFeatureReferences3](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument27~GetExternalFeatureReferences3.md) | Gets all of the external references, such as inserted or mirrored parts, related to features in parts in this document. |
