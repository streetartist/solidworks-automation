# ISwDMConfiguration11 Interface Properties

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11_properties`
...
For a list of all members of this type, see [ISwDMConfiguration11 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11_members.md).

# Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | [BOMPartNoSource](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11~BOMPartNoSource.md) | Gets or sets the source of the part number used in the bill of materials (BOM) for this configuration. |
| Property | [ShowChildComponentsInBOM](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11~ShowChildComponentsInBOM.md) | Obsolete. Superseded by [ISwDMConfiguration15::ShowChildComponentsInBOM2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration15~ShowChildComponentsInBOM2.md). |
