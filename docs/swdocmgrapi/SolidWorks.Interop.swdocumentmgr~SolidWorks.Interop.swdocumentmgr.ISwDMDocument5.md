# ISwDMDocument5 Interface

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument5`
![](dotnetimages/collapse.gif) ![](dotnetimages/expand.gif) ![](dotnetimages/collapse.gif) ![](dotnetimages/expand.gif) ![](dotnetimages/drpdown.gif) ![](dotnetimages/drpdown_orange.gif) ![](dotnetimages/copycode.gif) ![](dotnetimages/copycodeHighlight.gif)

|  |  |
| --- | --- |
| SOLIDWORKS Document Manager API Help | [Send comments](mailto:apihelp.feedback@3ds.com?subject=Documentation Feedback: SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument5.html) on this topic. |
| ISwDMDocument5 Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument5_members.md) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.md) : ISwDMDocument5 Interface |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface ISwDMDocument5     Inherits ISwDMDocument, ISwDMDocument3, ISwDMDocument4  ``` | |
...
| C# |  |
| --- | --- |
| ``` public interface ISwDMDocument5 : ISwDMDocument, ISwDMDocument3, ISwDMDocument4  ``` | |

| C++/CLI |  |
| --- | --- |
| ``` public interface class ISwDMDocument5 : public ISwDMDocument, ISwDMDocument3, ISwDMDocument4  ``` | |

# Visual Basic for Applications (VBA) Syntax

See [SwDMDocument5](swdocumentmgr~SwDMDocument5.md).
...
- You can access an ISwDMDocument5 object by calling QueryInterface on an [ISwDMDocument](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument.md) object in C++ or by direct assignment in Visual Basic.
- The SwDMDocument object can be assigned to an ISwDMDocument5 variable, just like the SOLIDWORKS [IModelDoc2](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDoc2.md) object can be assigned to a SOLIDWORKS [IPartDoc](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IPartDoc.md) variable.
