# ISwDMConfiguration11 Interface

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11`
![](dotnetimages/collapse.gif) ![](dotnetimages/expand.gif) ![](dotnetimages/collapse.gif) ![](dotnetimages/expand.gif) ![](dotnetimages/drpdown.gif) ![](dotnetimages/drpdown_orange.gif) ![](dotnetimages/copycode.gif) ![](dotnetimages/copycodeHighlight.gif)

|  |  |
| --- | --- |
| SOLIDWORKS Document Manager API Help | [Send comments](mailto:apihelp.feedback@3ds.com?subject=Documentation Feedback: SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11.html) on this topic. |
| ISwDMConfiguration11 Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11_members.md) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.md) : ISwDMConfiguration11 Interface |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface ISwDMConfiguration11     Inherits ISwDMConfiguration, ISwDMConfiguration10, ISwDMConfiguration2, ISwDMConfiguration3, ISwDMConfiguration4, ISwDMConfiguration5, ISwDMConfiguration6, ISwDMConfiguration7, ISwDMConfiguration8, ISwDMConfiguration9  ``` | |
...
| C# |  |
| --- | --- |
| ``` public interface ISwDMConfiguration11 : ISwDMConfiguration, ISwDMConfiguration10, ISwDMConfiguration2, ISwDMConfiguration3, ISwDMConfiguration4, ISwDMConfiguration5, ISwDMConfiguration6, ISwDMConfiguration7, ISwDMConfiguration8, ISwDMConfiguration9  ``` | |

| C++/CLI |  |
| --- | --- |
| ``` public interface class ISwDMConfiguration11 : public ISwDMConfiguration, ISwDMConfiguration10, ISwDMConfiguration2, ISwDMConfiguration3, ISwDMConfiguration4, ISwDMConfiguration5, ISwDMConfiguration6, ISwDMConfiguration7, ISwDMConfiguration8, ISwDMConfiguration9  ``` | |

# Visual Basic for Applications (VBA) Syntax

See [SwDMConfiguration11](swdocumentmgr~SwDMConfiguration11.md).

# Remarks

- You can access an ISwDMConfiguration11 object by calling QueryInterface on an [ISwDMConfiguration](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration.md) object in C++ or by direct assignment in Visual Basic.
- The ISwDMConfiguration object can be assigned to an ISwDMConfiguration11 variable, just like the SOLIDWORKS [IModelDoc2](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDoc2.md) object can be assigned to a SOLIDWORKS [IPartDoc](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IPartDoc.md) variable.
