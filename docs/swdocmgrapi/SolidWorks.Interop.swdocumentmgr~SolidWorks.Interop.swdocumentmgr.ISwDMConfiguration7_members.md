# ISwDMConfiguration7 Interface Members

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7_members`
...
The following tables list the members exposed by [ISwDMConfiguration7](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7.md).

# Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | [AlternateName2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~AlternateName2.md) | Gets or sets the user-specified name of the configuration. |
| Property | [Comment2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~Comment2.md) | Gets or sets the comment for the configuration. |
| Property | [Delete](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~Delete.md) | Gets or sets whether to mark this configuration as deleted. |
| Property | [Name2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~Name2.md) | Gets or sets the name of the configuration. |
| Property | [PreviewPNGStreamName](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~PreviewPNGStreamName.md) | Gets the name of the stream for the PNG preview bitmap of this configuration. |
...
|  | Name | Description |
| --- | --- | --- |
| Method | [GetPreviewPNGBitmap](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~GetPreviewPNGBitmap.md) | Gets the PNG preview bitmap for this configuration. |
