# ISwDMConfiguration10 Interface Members

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration10_members`
...
The following tables list the members exposed by [ISwDMConfiguration10](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration10.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetDisplayStates](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration10~GetDisplayStates.md) | Gets the names of the display states for this configuration. |
| Method | [IsDirty](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration10~IsDirty.md) | Gets whether this configuration is dirty (i.e., needs to be updated). |
