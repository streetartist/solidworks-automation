# ISwDMConfiguration4 Interface Members

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration4_members`
...
The following tables list the members exposed by [ISwDMConfiguration4](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration4.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetAllCustomPropertyNamesAndValues](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration4~GetAllCustomPropertyNamesAndValues.md) | Gets all of the custom properties for this configuration. |
