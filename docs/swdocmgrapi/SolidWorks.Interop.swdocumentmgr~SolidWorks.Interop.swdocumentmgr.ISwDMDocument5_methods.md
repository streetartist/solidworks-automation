# ISwDMDocument5 Interface Methods

Help ID: `SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument5_methods`
...
For a list of all members of this type, see [ISwDMDocument5 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument5_members.md).

# Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | [GetAllExternalReferences2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument5~GetAllExternalReferences2.md) | Obsolete. Superseded by [ISwDMDocument12::GetAllExternalReferences3](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument12~GetAllExternalReferences3.md). |
| Method | [GetCustomPropertyValues](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument5~GetCustomPropertyValues.md) | Gets the specified custom property value for this document. |
| Method | [GetLinkedAttachments](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument5~GetLinkedAttachments.md) | Gets the names of the linked documents. |
