...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks~INewAssembly`
...
Function INewAssembly() As AssemblyDoc
```

```

Dim instance As ISldWorks
Dim value As AssemblyDoc
 
value = instance.INewAssembly()
```

```

AssemblyDoc INewAssembly()
```
