# SetUserPreferenceInteger Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension~SetUserPreferenceInteger`
...
value = instance.SetUserPreferenceInteger(UserPref, UserPrefOption, Value)
```

```

System.bool SetUserPreferenceInteger( 
   System.int UserPref,
