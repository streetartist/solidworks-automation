# FeatureCut2 Method (IModelDoc)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc~FeatureCut2`

Obsolete. Superseded by IModelDoc2::FeatureCut2.
Obsolete. Superseded by [IModelDoc2::FeatureCut2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~FeatureCut2.md).
...
instance.FeatureCut2(Sd, Flip, Dir, T1, T2, D1, D2, Dchk1, Dchk2, Ddir1, Ddir2, Dang1, Dang2, OffsetReverse1, OffsetReverse2, KeepPieceIndex)
```
