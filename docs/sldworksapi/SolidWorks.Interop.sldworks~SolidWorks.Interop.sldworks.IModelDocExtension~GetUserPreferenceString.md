# GetUserPreferenceString Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension~GetUserPreferenceString`
...
Function GetUserPreferenceString( _
...
value = instance.GetUserPreferenceString(UserPref, UserPrefOption)
```
