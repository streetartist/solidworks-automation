# GetLineCount Method (ICustomSymbol)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICustomSymbol~GetLineCount`

Obsolete. Superseded by INote::GetLineCount.
Obsolete. Superseded by [INote::GetLineCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.INote~GetLineCount.md).
