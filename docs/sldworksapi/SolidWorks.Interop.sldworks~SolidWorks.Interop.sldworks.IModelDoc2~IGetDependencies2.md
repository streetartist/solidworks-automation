...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~IGetDependencies2`
...
 hres = TheApplication->m\_pSldWorks->GetUserPreferenceToggle ( swUseFolderSearchRules, &currentSearchFolderSetting );

 hres = TheApplication->m\_pSldWorks->GetSearchFolders ( swDocumentType, &currentSearchFolders );
...
 hres = TheApplication->m\_pSldWorks->SetSearchFolders ( swDocumentType, au2B(searchFolder), &ok );  

// Reset search folders to previous values

 hres = TheApplication->m\_pSldWorks->SetUserPreferenceToggle ( swUseFolderSearchRules, currentSearchFolderSetting );

 hres = TheApplication->m\_pSldWorks->SetSearchFolders ( swDocumentType, currentSearchFolders, &ok );
