...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IChamferFeatureData2~ReleaseSelectionAccess`
...
[IChamferFeatureData2::AccessSelections](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IChamferFeatureData2~AccessSelections.md) or [IChamferFeatureData2::IAccessSelections](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IChamferFeatureData2~IAccessSelections.md) puts the model into a rollback state to allow access to the selections that define this feature.
