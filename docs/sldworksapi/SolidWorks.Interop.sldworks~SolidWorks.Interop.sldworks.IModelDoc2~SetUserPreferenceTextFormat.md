# SetUserPreferenceTextFormat Method (IModelDoc2)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~SetUserPreferenceTextFormat`
...
*Value*
:   [Text format](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITextFormat.md) to which to assign the user preference specified in UserPreferenceValue
