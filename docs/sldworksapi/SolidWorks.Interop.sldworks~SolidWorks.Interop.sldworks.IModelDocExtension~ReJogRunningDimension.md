# ReJogRunningDimension Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension~ReJogRunningDimension`
...
instance.ReJogRunningDimension()
```
...
[IModelDocExtension::AddAngularRunningDim Method ()](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension~AddAngularRunningDim.md)
