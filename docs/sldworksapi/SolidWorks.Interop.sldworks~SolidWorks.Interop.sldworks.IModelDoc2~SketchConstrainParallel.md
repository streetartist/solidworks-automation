# SketchConstrainParallel Method (IModelDoc2)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~SketchConstrainParallel`
...
instance.SketchConstrainParallel()
```
