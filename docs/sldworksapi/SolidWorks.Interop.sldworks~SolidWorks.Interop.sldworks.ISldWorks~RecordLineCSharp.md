# RecordLineCSharp Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks~RecordLineCSharp`
...
*StringLine*
:   Text to write to a C# macro and the SOLIDWORKS journal file
...
- ISldWorks::RecordLineCSharp to record to a **SW VSTA C# Macro (\*.csproj)**.
