# IGetEllipses5 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~IGetEllipses5`
...
- in-process, unmanaged C++: Pointer to an array of doubles (**Remarks**)
...
[IView::GetEllipses5 Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetEllipses5.md)
