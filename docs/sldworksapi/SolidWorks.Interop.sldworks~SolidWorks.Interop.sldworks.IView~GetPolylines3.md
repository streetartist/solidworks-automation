# GetPolylines3 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetPolylines3`
...
Function GetPolylines3() As System.Object
```
...
value = instance.GetPolylines3()
```

```

System.object GetPolylines3()
```
