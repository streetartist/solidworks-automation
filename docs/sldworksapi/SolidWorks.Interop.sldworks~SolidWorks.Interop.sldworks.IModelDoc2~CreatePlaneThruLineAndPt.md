# CreatePlaneThruLineAndPt Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~CreatePlaneThruLineAndPt`
...
Function CreatePlaneThruLineAndPt( _
...
value = instance.CreatePlaneThruLineAndPt(AutoSize)
```

```

System.object CreatePlaneThruLineAndPt( 
