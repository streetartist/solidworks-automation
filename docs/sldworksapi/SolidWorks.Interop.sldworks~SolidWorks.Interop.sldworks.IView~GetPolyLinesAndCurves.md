# GetPolyLinesAndCurves Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetPolyLinesAndCurves`
...
Function GetPolyLinesAndCurves( _
...
value = instance.GetPolyLinesAndCurves(CrossHatchOption)
```

```

System.object GetPolyLinesAndCurves( 
...
Array of lines and parameters in the view (see Remarks)

Remarks

The difference between this method and [IView::GetPolylines7](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetPolylines7.md) is that splines and ellipses returned by this method are returned as equation parameters, which are more precise definitions.
...
- 2 = ellipses: Returned as equation parameters.
- 3 = splines: Returned as equation parameters.
...
- next six doubles are line attributes:
  ...
  - LayerID = integer value indicating which layer holds this polyline. The [ILayer](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILayer.md) object can be obtained by passing this integer value to [ILayerMgr::GetLayerById](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILayerMgr~GetLayerById.md).
...
| Items that were sketched in this drawing view | [IView::GetArcs4](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetArcs4.md)  [IView::GetLines4](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetLines4.md)  [IView::GetSplines3](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetSplines3.md)  [IView::GetEllipses5](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetEllipses5.md) |
