# GetConfigurationManagerTabIndex Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelViewManager~GetConfigurationManagerTabIndex`
...
Function GetConfigurationManagerTabIndex() As System.Integer
```
...
value = instance.GetConfigurationManagerTabIndex()
```

```

System.int GetConfigurationManagerTabIndex()
```
...
2 if in the Manager Pane; -1 if not
