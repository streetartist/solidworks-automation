...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IEdgeFlangeFeatureData~ReleaseSelectionAccess`
...
[IEdgeFlangeFeatureData::AccessSelections](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IEdgeFlangeFeatureData~AccessSelections.md) and [IEdgeFlangeFeatureData::IAccessSelections2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IEdgeFlangeFeatureData~IAccessSelections2.md)put the model into a rollback state to allow access to the selections that define this feature.
