# Get3DViewCount Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension~Get3DViewCount`

Gets the number of 3D Views in this part or assembly.
Gets the number of [3D Views](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView3D.md) in this part or assembly.
