# FeatureExtruRefSurface Method (IModelDoc)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc~FeatureExtruRefSurface`

Obsolete. Superseded by IModelDoc2::FetureExtruRefSurface.
Obsolete. Superseded by [IModelDoc2::FetureExtruRefSurface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~FeatureExtruRefSurface.md).
...
instance.FeatureExtruRefSurface(Sd, Flip, Dir, T1, T2, D1, D2, Dchk1, Dchk2, Ddir1, Ddir2, Dang1, Dang2, OffsetReverse1, OffsetReverse2)
```
