...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~GetTypeName2`

Gets the type of feature.
Gets the type of feature.

**NOTE:** To get the underlying type of feature of an Instant3D feature (i.e., "ICE"), call [IFeature::GetTypeName](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~GetTypeName.md); otherwise, call this method.
...
|  | NormalCut | [ISMNormalCutFeatureData2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISMNormalCutFeatureData2.md) |
...
**NOTE:** This method returns strings for some features shown in the FeatureManager design tree (e.g., **MateGroup**, **Weldment**, etc.) that set up the design functionality environment and, thus, do not have interfaces.
