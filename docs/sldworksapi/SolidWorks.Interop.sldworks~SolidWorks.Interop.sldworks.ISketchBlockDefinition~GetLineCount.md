...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchBlockDefinition~GetLineCount`
...
Call this method before calling [ISketchBlockDefinition::IGetLines](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchBlockDefinition~IGetLines.md) to get the size of the array for that method.
