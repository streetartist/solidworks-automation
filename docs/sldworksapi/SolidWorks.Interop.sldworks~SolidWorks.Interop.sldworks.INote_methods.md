...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.INote_methods`

Allows you to get standard note information.
For a list of all members of this type, see [INote members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.INote_members.md).
