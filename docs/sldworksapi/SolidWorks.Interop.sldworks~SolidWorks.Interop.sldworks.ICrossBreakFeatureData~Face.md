...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICrossBreakFeatureData~Face`
...
[Face](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFace2.md) to which to apply this cross break feature
