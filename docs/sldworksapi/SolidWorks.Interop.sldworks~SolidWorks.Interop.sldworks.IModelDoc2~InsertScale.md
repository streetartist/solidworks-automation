...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~InsertScale`

Obsolete. Superseded by IFeatureManager::InsertScale.
Obsolete. Superseded by [IFeatureManager::InsertScale](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~InsertScale.md).
