# ISFSymbol Interface Methods

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISFSymbol_methods`

Allows access to display information for surface finish symbols.
For a list of all members of this type, see [ISFSymbol members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISFSymbol_members.md).
