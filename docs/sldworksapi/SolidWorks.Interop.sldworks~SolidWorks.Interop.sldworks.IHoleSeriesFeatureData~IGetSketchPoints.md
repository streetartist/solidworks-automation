...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IHoleSeriesFeatureData~IGetSketchPoints`

Obsolete. Superseded by IHoleSeriesFeatureData2::IGetSketchPoints.
Obsolete. Superseded by [IHoleSeriesFeatureData2::IGetSketchPoints](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IHoleSeriesFeatureData2~IGetSketchPoints.md).
...
Before calling this method, call [IHoleSeriesFeatureData::GetSketchPointsCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IHoleSeriesFeatureData~GetSketchPointsCount.md) to get the value for NCount.
