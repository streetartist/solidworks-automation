# ICreateAuxiliaryViewAt2 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDrawingDoc~ICreateAuxiliaryViewAt2`
...
Pointer to the newly created auxiliary [view](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView.md)
