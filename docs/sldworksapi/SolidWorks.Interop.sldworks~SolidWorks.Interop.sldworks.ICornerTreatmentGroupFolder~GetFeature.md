# GetFeature Method (ICornerTreatmentGroupFolder)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICornerTreatmentGroupFolder~GetFeature`

Gets the feature for this corner treatment group folder.
Gets the feature for this corner treatment group folder.
