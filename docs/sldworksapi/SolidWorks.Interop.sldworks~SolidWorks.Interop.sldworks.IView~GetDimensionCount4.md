# GetDimensionCount4 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetDimensionCount4`
...
Function GetDimensionCount4() As System.Integer
```
...
value = instance.GetDimensionCount4()
```

```

System.int GetDimensionCount4()
```
