# ICreateSplinesByEqnParams Method (IModelDoc2)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ICreateSplinesByEqnParams`

Obsolete. Superseded by ISketchManager::ICreateSplinesByEqnParams.
Obsolete. Superseded by [ISketchManager::ICreateSplinesByEqnParams](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager~ICreateSplinesByEqnParams.md).
...
Pointer to the newly created [splines enumeration](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IEnumSketchSegments.md) (see **Remarks**)
