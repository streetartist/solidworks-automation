# SimpleHole Method (IModelDoc)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc~SimpleHole`

Obsolete. Superseded by IModelDoc2::SimpleHole.
Obsolete. Superseded by [IModelDoc2::SimpleHole](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~SimpleHole.md).
...
instance.SimpleHole(Sd, Flip, Dir, T1, T2, D1, D2, Dchk1, Dchk2, Ddir1, Ddir2, Dang1, Dang2, OffsetReverse1, OffsetReverse2)
```
