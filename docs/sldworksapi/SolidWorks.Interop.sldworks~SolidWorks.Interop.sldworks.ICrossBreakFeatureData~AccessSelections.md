...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICrossBreakFeatureData~AccessSelections`
...
- [ICrossBreakFeatureData::ReleaseSelectionAccess](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICrossBreakFeatureData~ReleaseSelectionAccess.md) if you did not
