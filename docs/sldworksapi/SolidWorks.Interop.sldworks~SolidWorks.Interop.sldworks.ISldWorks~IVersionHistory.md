...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks~IVersionHistory`
...
To get the size of array needed by this method, call [ISldWorks::IGetVersionHistoryCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks~IGetVersionHistoryCount.md). If the file is not found or an error occurs, then SldWorks::IGetVersionHistoryCount returns 0, and this method returns VT\_EMPTY.
