# SimpleHole Method (IFeatureManager)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~SimpleHole`

Obsolete. Superseded by IFeatureManager::SimpleHole2.
Obsolete. Superseded by [IFeatureManager::SimpleHole2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~SimpleHole2.md).
...
value = instance.SimpleHole(Dia, Sd, Flip, Dir, T1, T2, D1, D2, Dchk1, Dchk2, Ddir1, Ddir2, Dang1, Dang2, OffsetReverse1, OffsetReverse2, TranslateSurface1, TranslateSurface2, UseFeatScope, UseAutoSelect)
```
