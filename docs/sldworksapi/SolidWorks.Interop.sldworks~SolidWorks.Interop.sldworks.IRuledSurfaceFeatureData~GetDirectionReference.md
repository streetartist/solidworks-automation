...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRuledSurfaceFeatureData~GetDirectionReference`
...
This method is only available when [IRuledSurfaceFeatureData::Type](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRuledSurfaceFeatureData~Type.md) is set to swRuledSurfaceType\_TaperedToVector, swRuledSurfaceType\_PerpendicularToVector, or swRuledSurfaceType\_Sweep.
...
[IRuledSurfaceFeatureData::SetDirectionReference Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRuledSurfaceFeatureData~SetDirectionReference.md)
