...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRipFeatureData~ReleaseSelectionAccess`
...
[IRipFeatureData::AccessSelections](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRipFeatureData~AccessSelections.md) and [IRipFeatureData::IAccessSelections](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRipFeatureData~IAccessSelections.md) put the model in a rollback state to allow access to the selections that define the feature.
