# CreatePlanePerCurveAndPassPoint3 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~CreatePlanePerCurveAndPassPoint3`
...
Function CreatePlanePerCurveAndPassPoint3( _
...
value = instance.CreatePlanePerCurveAndPassPoint3(OrigAtCurve, AutoSize)
```
