...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModeler~CreateBsplineSurface`
...
B-spline [surface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurface.md)
...
[IIModeler::CreateBsplineCurve Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModeler~ICreateBsplineCurve.md)  
