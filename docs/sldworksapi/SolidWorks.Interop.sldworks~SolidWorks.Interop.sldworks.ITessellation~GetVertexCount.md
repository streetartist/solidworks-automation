# GetVertexCount Method (ITessellation)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITessellation~GetVertexCount`
...
Number of vertices for this tessellation
