...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICurve_methods`

Allows access to a curve and its parameters in their native form or in terms of b-curve data.
For a list of all members of this type, see [ICurve members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICurve_members.md).
