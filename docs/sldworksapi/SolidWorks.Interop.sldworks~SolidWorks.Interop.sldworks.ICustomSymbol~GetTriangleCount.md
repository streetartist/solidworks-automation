...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICustomSymbol~GetTriangleCount`

Obsolete. Superseded by INote::GetTriangleCount.
Obsolete. Superseded by [INote::GetTriangleCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.INote~GetTriangleCount.md).
