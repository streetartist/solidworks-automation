# IGetCenterMarkInfo Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~IGetCenterMarkInfo`
...
Function IGetCenterMarkInfo() As System.Double
```
...
value = instance.IGetCenterMarkInfo()
```

```

System.double IGetCenterMarkInfo()
```
