...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData~GetModuleCount`
...
Call this method before calling [IMacroFeatureData::IGetModuleNames](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData~IGetModuleNames.md) to determine the size of the array for that method.
