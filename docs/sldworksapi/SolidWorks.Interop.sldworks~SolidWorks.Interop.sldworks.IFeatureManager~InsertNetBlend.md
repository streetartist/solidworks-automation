# InsertNetBlend Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~InsertNetBlend`

Obsolete. Superseded by IFeatureManager::InsertNetBlend2.
Obsolete. Superseded by [IFeatureManager::InsertNetBlend2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~InsertNetBlend2.md).
...
Use [IModelDocExtension::SelectByID2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension~SelectByID2.md) to select the entities for a boundary feature or boundary surface feature. The following table contains valid selection marks for this method and these features.

| Feature | Selection marks |
| --- | --- |
| Boundary | Sketch curves:   - Direction 1: 8193, 16385, 24577 - Direction 2: 8194, 16386, 24578   Faces:   - Direction 1: 8193, 16385, 24577 - Direction 2: 8194, 16386, 24578   Other sketch entities (3D sketch (Unknown/SELOBJGROUP):   - Direction 1: 12289, 24577 - Direction 2: 16386, 28674 |
| Boundary surface | Sketch curves:   - Direction 1: 1 - Direction 2: 2 |
