...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoop2~RevolvePlanarLoop`
...
Array containing new [body](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2.md) (element 1) and two stop [faces](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFace2.md) (elements 2 and 3)
...
[ILoop2::IRevolvePlanarLoop Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoop2~IRevolvePlanarLoop.md)
