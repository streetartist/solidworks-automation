...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetPolylines6`

Obsolete. Superseded by IView::GetPolylines7.
Obsolete. Superseded by [IView::GetPolylines7](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetPolylines7.md).
