...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchPath~GetRelationsCount`
...
Call this method before calling [ISketchPath::IGetRelations](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchPath~IGetRelations.md) to get the size of the array for that method.
