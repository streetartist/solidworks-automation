# ICreatePlaneThruLineAndPt Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ICreatePlaneThruLineAndPt`
...
Function ICreatePlaneThruLineAndPt( _
...
value = instance.ICreatePlaneThruLineAndPt(AutoSize)
```

```

RefPlane ICreatePlaneThruLineAndPt( 
