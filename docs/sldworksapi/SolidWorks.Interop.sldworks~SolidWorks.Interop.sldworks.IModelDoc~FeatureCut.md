# FeatureCut Method (IModelDoc)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc~FeatureCut`

Obsolete. Superseded by IModelDoc2::FeatureCut.
Obsolete. Superseded by [IModelDoc2::FeatureCut](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~FeatureCut.md).
...
instance.FeatureCut(Sd, Flip, Dir, T1, T2, D1, D2, Dchk1, Dchk2, Ddir1, Ddir2, Dang1, Dang2, OffsetReverse1, OffsetReverse2)
```
