# ISketchBlockDefinition Interface Methods

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchBlockDefinition_methods`

Allows access to information about a block definition.
For a list of all members of this type, see [ISketchBlockDefinition members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchBlockDefinition_members.md).
