# SecurityHandleMacroFileName Property

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData~SecurityHandleMacroFileName`
...
Property SecurityHandleMacroFileName As System.String
```
...
instance.SecurityHandleMacroFileName = value
 
value = instance.SecurityHandleMacroFileName
```

```

System.string SecurityHandleMacroFileName {get; set;}
```

```

property System.String^ SecurityHandleMacroFileName {
   System.String^ get();
