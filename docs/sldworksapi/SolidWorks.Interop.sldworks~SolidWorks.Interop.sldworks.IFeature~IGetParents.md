...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~IGetParents`
...
To determine the size of the array, call [IFeature::IGetParentCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~IGetParentCount.md) before calling this method.
