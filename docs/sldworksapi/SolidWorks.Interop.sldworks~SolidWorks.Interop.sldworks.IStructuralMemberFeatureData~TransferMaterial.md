# TransferMaterial Property

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IStructuralMemberFeatureData~TransferMaterial`

Gets or sets whether to transfer the material properties of a library profile for this structural member.
Gets or sets whether to transfer the [material properties of a library profile](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IStructuralMemberFeatureData~LibraryProfileMaterial.md) for this structural member.
