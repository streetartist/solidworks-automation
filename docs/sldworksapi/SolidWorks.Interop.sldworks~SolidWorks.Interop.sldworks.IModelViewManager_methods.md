...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelViewManager_methods`

Allows access to the model view.
For a list of all members of this type, see [IModelViewManager members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelViewManager_members.md).
