# GetNext Method (ILoop)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoop~GetNext`

Obsolete. Superseded by ILoop2::GetNext.
Obsolete. Superseded by [ILoop2::GetNext](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoop2~GetNext.md).
