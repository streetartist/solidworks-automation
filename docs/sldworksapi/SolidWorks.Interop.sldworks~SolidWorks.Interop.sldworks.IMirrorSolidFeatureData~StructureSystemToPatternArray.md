# StructureSystemToPatternArray Property (IMirrorSolidFeatureData)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMirrorSolidFeatureData~StructureSystemToPatternArray`
...
'VBA  
'This example demonstrates how to create a mirror feature using a structure system.  
'==========================================================================================  
'Preconditions:  
...
' 5. Creates a solid body to pattern.  
' 6. Inspect the graphics area.  
' 7. Press F5 to create **Mirror1**.  
...
     
    'Pre-select mirror face, bodies, structure system folders  
    swModel.ClearSelection2 True

    status = swModelDocExt.SelectByRay(1.44449597678107, -1.08350443384643, 3.67298798859679E-02, -0.790470353092525, -0.254349019385703, -0.557192244399822, 2.59382235707926E-02, 2, False, 2, 0)  
...
     
    Set swFeature = swFeatureMgr.**InsertMirrorFeature2**(True, False, False, False, swFeatureScope\_e.swFeatureScope\_AllBodies)  
             
    Stop

    swModel.ClearSelection2 True  
    status = swModelDocExt.SelectByID2("Mirror1", "BODYFEATURE", 0, 0, 0, False, 0, Nothing, 0)  
    Set swFeature = swSelectionMgr.GetSelectedObject6(1, -1)  
    Set swMirrorSolidFeatureData = swFeature.**GetDefinition**  
    swMirrorSolidFeatureData.**AccessSelections** swModel, Nothing  
         
    Dim var As Variant  
    var = swMirrorSolidFeatureData.**StructureSystemToPatternArray**  
     
...
        Debug.Print "Profile group folders count: " & strctSysFolder.GetProfileGroupFoldersCount  
    Next  
     
...
    
    ''During mirror solid modification, use StructureSystemPatternArray property to change structure system to pattern  
    'swMirrorSolidFeatureData.StructureSystemToPatternArray = patternFeatures  
     
    Debug.Print swFeature.**ModifyDefinition**(swMirrorSolidFeatureData, swModel, Nothing)  
     
End Sub
