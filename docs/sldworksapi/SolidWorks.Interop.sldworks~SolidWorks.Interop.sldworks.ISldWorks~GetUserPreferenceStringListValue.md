# GetUserPreferenceStringListValue Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks~GetUserPreferenceStringListValue`
...
Function GetUserPreferenceStringListValue( _
...
value = instance.GetUserPreferenceStringListValue(UserPreference)
```
