...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketch~GetSketchPathCount`
...
Call this method before calling [ISketch::IGetSketchPaths](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketch~IGetSketchPaths.md) to get the sketch paths in this sketch.
