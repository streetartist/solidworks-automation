# IGetFrameSymbols2 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IGtol~IGetFrameSymbols2`
...
Use this method with [IGtol::IGetFrameDiameterSymbols](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IGtol~IGetFrameDiameterSymbols.md), which determines whether diameter symbols are displayed.
