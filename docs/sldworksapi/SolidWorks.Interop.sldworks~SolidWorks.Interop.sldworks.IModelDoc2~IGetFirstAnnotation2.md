...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~IGetFirstAnnotation2`
...
First [annotation](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAnnotation.md) in model
...
[IModelDoc2::GetFirstAnnotation2 Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~GetFirstAnnotation2.md)
