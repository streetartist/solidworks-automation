...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRenderMaterial~FitHeight`
...
Call [IRenderMaterial::FitWidth](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRenderMaterial~FitWidth.md) to get or set whether to stretch the width of the appearance texture to the selected entity.
