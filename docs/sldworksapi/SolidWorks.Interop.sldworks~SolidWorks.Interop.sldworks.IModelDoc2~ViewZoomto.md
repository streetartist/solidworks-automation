# ViewZoomto Method (IModelDoc2)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ViewZoomto`
...
See [IModelDoc2::ViewZoomTo2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ViewZoomTo2.md), which allows you to zoom to an X,Y,Z boxed location.
