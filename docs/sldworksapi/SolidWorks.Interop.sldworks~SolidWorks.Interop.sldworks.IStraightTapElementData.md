...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IStraightTapElementData`
...
Public Interface IStraightTapElementData 
```
...
public interface class IStraightTapElementData 
```
