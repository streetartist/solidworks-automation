# IGetPolylines3 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~IGetPolylines3`
...
Function IGetPolylines3() As System.Double
```
...
value = instance.IGetPolylines3()
```

```

System.double IGetPolylines3()
```
