...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetXform`
...
[IView::GetViewXform](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetViewXform.md) and [IView::IGetViewXform](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~IGetViewXform.md) get the transform from model space origin to drawing space origin.
