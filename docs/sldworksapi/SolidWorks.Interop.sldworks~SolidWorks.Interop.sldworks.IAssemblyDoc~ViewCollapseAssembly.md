# ViewCollapseAssembly Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAssemblyDoc~ViewCollapseAssembly`
...
Use this method with [IAssemblyDoc::ViewExplodeAssembly](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAssemblyDoc~ViewExplodeAssembly.md) to toggle the display of the exploded assembly view.
