...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITreeControlItem~GetNext`
...
[Next sibling of this item in the FeatureManager design tree](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITreeControlItem.md)

Remarks

Use [ITreeControlItem::GetPrevious](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITreeControlItem~GetPrevious.md) to get the previous sibling of this item in the FeatureManager design tree.
