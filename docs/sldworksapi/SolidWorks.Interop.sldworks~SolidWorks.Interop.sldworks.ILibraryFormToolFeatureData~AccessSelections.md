# AccessSelections Method (ILibraryFormToolFeatureData)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILibraryFormToolFeatureData~AccessSelections`

Gains access to selections that define this library forming tool feature.
Gains access to selections that define this library forming tool feature.
...
- [ILibraryFormToolFeatureData::ReleaseSelectionAccess](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILibraryFormToolFeatureData~ReleaseSelectionAccess.md) if you did not
