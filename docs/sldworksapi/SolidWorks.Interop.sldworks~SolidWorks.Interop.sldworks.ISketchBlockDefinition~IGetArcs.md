# IGetArcs Method (ISketchBlockDefinition)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchBlockDefinition~IGetArcs`
...
value = instance.IGetArcs(ArraySize)
```
...
Call [ISketchBlockDefinition::GetArcCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchBlockDefinition~GetArcCount.md) before calling this method to get the value for ArraySize.
...
[ISketchBlockDefinition::GetArcs Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchBlockDefinition~GetArcs.md)
