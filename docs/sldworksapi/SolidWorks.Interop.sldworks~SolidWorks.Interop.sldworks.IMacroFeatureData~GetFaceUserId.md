...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData~GetFaceUserId`
...
value = instance.GetFaceUserId(Face, Id1, Id2)
```

```

System.bool GetFaceUserId( 
   Face2 Face,
   out System.int Id1,
   out System.int Id2
)
