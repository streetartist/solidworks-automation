# GetUserPreferenceInteger Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension~GetUserPreferenceInteger`
...
value = instance.GetUserPreferenceInteger(UserPref, UserPrefOption)
```

```

System.int GetUserPreferenceInteger( 
   System.int UserPref,
