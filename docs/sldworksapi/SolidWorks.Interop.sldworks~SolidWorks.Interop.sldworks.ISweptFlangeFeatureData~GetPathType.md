...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISweptFlangeFeatureData~GetPathType`

Gets the type of the sweep path in this swept flange feature.
Gets the type of the [sweep path](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISweptFlangeFeatureData~Path.md) in this swept flange feature.
