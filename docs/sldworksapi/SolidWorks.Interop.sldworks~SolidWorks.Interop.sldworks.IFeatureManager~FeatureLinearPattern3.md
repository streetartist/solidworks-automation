# FeatureLinearPattern3 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~FeatureLinearPattern3`

Obsolete. Superseded by IFeatureManager::FeatureLinearPattern4.
Obsolete. Superseded by [IFeatureManager::FeatureLinearPattern4](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~FeatureLinearPattern4.md).
...
*FlipDir1*
:   True if you want to reverse the direction of the linear pattern in Direction 1, false if not
...
| Directly selecting a feature or component | [IFeature::Select2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~Select2.md) | [ISelectData::Mark](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISelectData~Mark.md) and [IComponent2::Select3](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IComponent2~Select3.md) |
