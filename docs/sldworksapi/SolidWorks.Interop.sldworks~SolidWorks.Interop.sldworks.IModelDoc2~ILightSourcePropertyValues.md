# ILightSourcePropertyValues Property (IModelDoc2)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ILightSourcePropertyValues`
...
- in-process, unmanaged C++: Pointer to an array of 19 doubles containing the light source properties (see **Remarks**)
