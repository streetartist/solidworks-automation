# FeatureExtrusionThin Method (IPartDoc)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPartDoc~FeatureExtrusionThin`
...
instance.FeatureExtrusionThin(Sd, Flip, Dir, T1, T2, D1, D2, Dchk1, Dchk2, Ddir1, Ddir2, Dang1, Dang2, OffsetReverse1, OffsetReverse2, Thk1, Thk2, EndThk, RevThinDir, CapEnds, AddBends, BendRad)
```

```

void FeatureExtrusionThin( 
   System.bool Sd,
   System.bool Flip,
   System.bool Dir,
   System.int T1,
