...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2_members`

Allows access to the faces on a body and the ability to create surfaces for sewing into a body object.
The following tables list the members exposed by [IBody2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2.md).

Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | [Check3](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~Check3.md) | Gets whether the body is a valid and returns an [IFaultEntity](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFaultEntity.md) object if any faults exist. |
| Property | [DisableDisplay](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~DisableDisplay.md) | Gets or sets whether to hide or show this body. |
| Property | [DisableHighlight](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~DisableHighlight.md) | Disables highlighting of the selected body in the graphics area. |
| Property | [IMaterialPropertyValues](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~IMaterialPropertyValues.md) | Obsolete. Superseded by [IBody2::IMaterialPropertyValues2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~IMaterialPropertyValues2.md). |
| Property | [IMaterialPropertyValues2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~IMaterialPropertyValues2.md) | Gets or sets the material properties for a body other than the base body in the active configuration. |
| Property | [IsSafe](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~IsSafe.md) | Not implemented. |
| Property | [MaterialPropertyValues](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~MaterialPropertyValues.md) | Obsolete. Superseded by [IBody2::MaterialPropertyValues2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~MaterialPropertyValues2.md). |
| Property | [MaterialPropertyValues2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~MaterialPropertyValues2.md) | Gets or sets the material properties for a body other than the base body in the active configuration. |
| Property | [Name](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~Name.md) | Gets or sets the name of the selected body. |
| Property | [Visible](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~Visible.md) | Gets whether this body is visible or hidden. |
