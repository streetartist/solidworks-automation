# GetTextAndCustomProperties Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMBD3DPdfData~GetTextAndCustomProperties`

Gets the text and custom properties in the theme for this SOLIDWORKS MBD 3D PDF.
Gets the text and custom properties in the [theme](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMBD3DPdfData~ThemeName.md) for this SOLIDWORKS MBD 3D PDF.
...
Array of [text and custom properties](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITextAndCustomProperty.md) in the theme for this SOLIDWORKS MBD 3D PDF
