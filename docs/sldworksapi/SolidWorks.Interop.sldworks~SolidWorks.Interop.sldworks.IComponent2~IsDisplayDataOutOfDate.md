...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IComponent2~IsDisplayDataOutOfDate`
...
Rebuild state of the components as defined in [swOutOfDateStatus\_e](ms-help://SolidWorks.Interop.swconst/SolidWorks/SOLIDWORKS.Interop.swconst~SOLIDWORKS.Interop.swconst.swOutOfDateStatus_e.html)
