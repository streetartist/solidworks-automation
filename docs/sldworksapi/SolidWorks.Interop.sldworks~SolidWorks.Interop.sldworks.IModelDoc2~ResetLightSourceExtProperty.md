# ResetLightSourceExtProperty Method (IModelDoc2)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ResetLightSourceExtProperty`
...
Sub ResetLightSourceExtProperty( _
...
instance.ResetLightSourceExtProperty(ID)
```
...
Values for Id can range from 0 to n, where n = (the total number of light sources - 1). To get the total number of light sources, see [IModelDoc2::GetLightSourceCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~GetLightSourceCount.md).
