# ViewExplodeAssembly Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAssemblyDoc~ViewExplodeAssembly`
...
Use this method with [IAssemblyDoc::ViewCollapseAssembly](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAssemblyDoc~ViewCollapseAssembly.md) to toggle the display of the exploded assembly view.
