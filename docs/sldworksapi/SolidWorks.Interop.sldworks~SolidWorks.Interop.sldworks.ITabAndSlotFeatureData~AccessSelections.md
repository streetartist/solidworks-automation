# AccessSelections Method (ITabAndSlotFeatureData)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITabAndSlotFeatureData~AccessSelections`
...
- [ITabAndSlotFeatureData::ReleaseSelectionAccess](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITabAndSlotFeatureData~ReleaseSelectionAccess.md) if you did not
