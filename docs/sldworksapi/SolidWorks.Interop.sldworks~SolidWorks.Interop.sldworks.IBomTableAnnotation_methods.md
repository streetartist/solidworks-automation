...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBomTableAnnotation_methods`

Allows access to the IBomFeature object for this table annotation.
For a list of all members of this type, see [IBomTableAnnotation members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBomTableAnnotation_members.md).
