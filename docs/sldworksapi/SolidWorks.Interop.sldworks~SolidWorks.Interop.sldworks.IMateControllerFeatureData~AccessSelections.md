# AccessSelections Method (IMateControllerFeatureData)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMateControllerFeatureData~AccessSelections`

Accesses the selections used to define this mate controller feature.
Accesses the selections used to define this mate controller feature.
...
- [IMateControllerFeatureData::ReleaseSelectionAccess](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMateControllerFeatureData~ReleaseSelectionAccess.md) if you did not
