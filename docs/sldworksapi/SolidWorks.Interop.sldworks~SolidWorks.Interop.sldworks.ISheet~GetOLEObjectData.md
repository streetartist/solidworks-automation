# GetOLEObjectData Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISheet~GetOLEObjectData`
...
value = instance.GetOLEObjectData(Index)
```

```

System.object GetOLEObjectData( 
   System.int Index
)
```
