# GetDetailCircles Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetDetailCircles`
...
Function GetDetailCircles() As System.Object
```
...
value = instance.GetDetailCircles()
```

```

System.object GetDetailCircles()
```
...
[Detail circles](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDetailCircle.md)
