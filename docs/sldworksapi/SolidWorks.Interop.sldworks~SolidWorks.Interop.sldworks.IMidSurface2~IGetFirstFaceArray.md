...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMidSurface2~IGetFirstFaceArray`

Obsolete. Superseded by IMidSurface3::IGetFirstFaceArray.
Obsolete. Superseded by [IMidSurface3::IGetFirstFaceArray](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMidSurface3~IGetFirstFaceArray.md).
...
- Call [IMidSurface2::IGetNextFaceArray](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMidSurface2~IGetNextFaceArray.md) four times.
...
To get the next face from the original paired faces, call [IMidSurface2::IGetNextFaceArray](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMidSurface2~IGetNextFaceArray.md).
