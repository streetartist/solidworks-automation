# AccessSelections Method (IGussetFeatureData)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IGussetFeatureData~AccessSelections`
...
- [IGussetFeatureData::ReleaseSelectionAccess](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IGussetFeatureData~ReleaseSelectionAccess.md) if you did not
