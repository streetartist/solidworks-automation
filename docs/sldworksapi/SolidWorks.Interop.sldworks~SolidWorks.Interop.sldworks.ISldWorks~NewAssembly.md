...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks~NewAssembly`
...
Function NewAssembly() As System.Object
```
...
value = instance.NewAssembly()
```

```

System.object NewAssembly()
```
