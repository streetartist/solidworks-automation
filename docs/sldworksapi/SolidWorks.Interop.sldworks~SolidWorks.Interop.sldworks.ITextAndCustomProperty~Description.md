...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITextAndCustomProperty~Description`

Gets the description of the text or custom property in a theme for a SOLIDWORKS MBD 3D PDF.
Gets the description of the text or custom property in a [theme](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMBD3DPdfData~ThemeName.md) for a [SOLIDWORKS MBD 3D PDF](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMBD3DPdfData.md).
...
This property corresponds to the **Instructions** text box in a **Text Field** or **Custom Property Field** group box in a theme.
