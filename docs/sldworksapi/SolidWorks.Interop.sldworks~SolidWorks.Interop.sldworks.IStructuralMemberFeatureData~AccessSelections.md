...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IStructuralMemberFeatureData~AccessSelections`
...
- [IStructuralMemberFeatureData::ReleaseSelctionAccess](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IStructuralMemberFeatureData~ReleaseSelectionAccess.md) if you did not
