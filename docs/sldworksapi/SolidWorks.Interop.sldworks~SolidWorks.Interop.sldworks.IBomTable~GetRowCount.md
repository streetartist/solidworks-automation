...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBomTable~GetRowCount`

Obsolete. Superseded by IBomTable::GetTotalRowCount.
Obsolete. Superseded by [IBomTable::GetTotalRowCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBomTable~GetTotalRowCount.md).
