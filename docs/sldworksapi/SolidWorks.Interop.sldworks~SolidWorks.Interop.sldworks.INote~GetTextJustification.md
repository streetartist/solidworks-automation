...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.INote~GetTextJustification`
...
Function GetTextJustification() As System.Integer
```
...
System.int GetTextJustification()
```
