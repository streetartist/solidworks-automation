...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~InsertCurveFileBegin`
...
- is the first method called that create a curve. This method must precede all calls to [IModelDoc2::InsertCurveFilePoint](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~InsertCurveFilePoint.md).
- and [IModelDoc2::InsertCurveFileEnd](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~InsertCurveFileEnd.md) must enclose all of the calls to IModelDoc2::InsertCurveFilePoint.
