...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks~NewPart`
...
Function NewPart() As System.Object
```
...
value = instance.NewPart()
```

```

System.object NewPart()
```
