# ICreateEllipse2 Method (IModelDoc2)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ICreateEllipse2`
...
Newly created [ellipse](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchSegment.md)
...
To create a partial ellipse, use [IModelDoc2::CreateEllipticalArcByCenter](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~CreateEllipticalArcByCenter.md) or [IModelDoc2::ICreateEllipticalArcByCenter](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ICreateEllipticalArcByCenter.md).
