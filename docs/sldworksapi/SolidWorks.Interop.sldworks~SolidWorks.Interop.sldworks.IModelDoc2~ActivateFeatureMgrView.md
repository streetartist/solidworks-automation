...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ActivateFeatureMgrView`

Obsolete. Superseded by IFeatureMgrView::ActivateView.
Obsolete. Superseded by [IFeatureMgrView::ActivateView](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatMgrView~ActivateView.md).
