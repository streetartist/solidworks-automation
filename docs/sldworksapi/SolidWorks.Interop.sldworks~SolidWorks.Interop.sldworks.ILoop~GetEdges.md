# GetEdges Method (ILoop)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoop~GetEdges`

Obsolete. Superseded by ILoop2::GetEdges.
Obsolete. Superseded by [ILoop2::GetEdges](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoop2~GetEdges.md).
