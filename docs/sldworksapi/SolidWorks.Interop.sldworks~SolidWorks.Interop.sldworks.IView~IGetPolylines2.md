# IGetPolylines2 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~IGetPolylines2`
...
Function IGetPolylines2() As System.Double
```
...
value = instance.IGetPolylines2()
```

```

System.double IGetPolylines2()
```
