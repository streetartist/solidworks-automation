...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~AutoSolveToggle`

Obsolete. Superseded by ISketchManager::AutoSolve.
Obsolete. Superseded by [ISketchManager::AutoSolve](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager~AutoSolve.md).
