# AccessSelections Method (IIndentFeatureData)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IIndentFeatureData~AccessSelections`
...
- [IIndentFeatureData::ReleaseSelectionAccess](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IIndentFeatureData~ReleaseSelectionAccess.md) if you did not
