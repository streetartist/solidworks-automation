...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketch~GetEllipseCount`
...
Call this method before calling [ISketch::GetEllipses3](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketch~GetEllipses3.md) to determine the size of the array for that method.
