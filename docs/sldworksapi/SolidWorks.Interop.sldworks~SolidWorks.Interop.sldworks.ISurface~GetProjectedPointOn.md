...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurface~GetProjectedPointOn`
...
[Point](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMathPoint.md) where the input point is projected onto the surface
