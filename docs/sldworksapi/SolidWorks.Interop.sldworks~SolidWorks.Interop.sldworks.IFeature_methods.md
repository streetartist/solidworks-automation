...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature_methods`

Allows access to the feature type, name, parameter data, and the next feature in the FeatureManager design tree.
For a list of all members of this type, see [IFeature members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature_members.md).
