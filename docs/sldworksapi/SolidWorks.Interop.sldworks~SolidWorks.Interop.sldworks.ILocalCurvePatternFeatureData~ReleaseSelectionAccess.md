# ReleaseSelectionAccess Method (ILocalCurvePatternFeatureData)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILocalCurvePatternFeatureData~ReleaseSelectionAccess`
...
[ILocalCurvePatternFeatureData::AccessSelections](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILocalCurvePatternFeatureData~AccessSelections.md) puts the model into a rollback state to allow access to the selections that define this feature.
