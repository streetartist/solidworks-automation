# GetPropertyManagerHandleProcedureCount Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData~GetPropertyManagerHandleProcedureCount`
...
Call this method before calling [IMacroFeatureData::IGetPropertyManagerHandleProcedureNames](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData~IGetPropertyManagerHandleProcedureNames.md) to determine the size of the array for that method.
