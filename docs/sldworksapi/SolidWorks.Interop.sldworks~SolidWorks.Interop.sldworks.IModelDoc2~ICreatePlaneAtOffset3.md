# ICreatePlaneAtOffset3 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ICreatePlaneAtOffset3`
...
Function ICreatePlaneAtOffset3( _
...
value = instance.ICreatePlaneAtOffset3(Val, FlipDir, AutoSize)
```
