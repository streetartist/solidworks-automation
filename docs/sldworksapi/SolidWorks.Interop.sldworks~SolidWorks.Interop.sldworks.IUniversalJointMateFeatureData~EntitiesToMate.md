...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IUniversalJointMateFeatureData~EntitiesToMate`
...
Populate the array of this property with the cylindrical [faces](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFace2.md) of two shaft components.
