...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFace2_methods`

Allows access to the underlying edge, loop, and surface to the owning body or feature, and to face tessellation, trim data.
For a list of all members of this type, see [IFace2 members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFace2_members.md).
