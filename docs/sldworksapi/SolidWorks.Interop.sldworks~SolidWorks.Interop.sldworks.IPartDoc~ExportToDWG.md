...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPartDoc~ExportToDWG`
...
value = instance.ExportToDWG(FilePath, ModelName, Action, ExportToSingleFile, Alignment, IsXDirFlipped, IsYDirFlipped, SheetMetalOptions, Views)
```

```

System.bool ExportToDWG( 
...
*FilePath*
:   Full path to the directory of the exported DXF/DWG file

*ModelName*
:   File and path name of the active part document
...
[IPartDoc::IExportToDWG Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPartDoc~IExportToDWG.md)
