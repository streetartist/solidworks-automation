# AddRadialDimension2 Method (IModelDoc2)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~AddRadialDimension2`
...
Function AddRadialDimension2( _
...
value = instance.AddRadialDimension2(X, Y, Z)
```
...
[Dimension](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDisplayDimension.md)
...
[IDisplayDimension::ArcExtensionLineOrOppositeSide Property](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDisplayDimension~ArcExtensionLineOrOppositeSide.md)  
