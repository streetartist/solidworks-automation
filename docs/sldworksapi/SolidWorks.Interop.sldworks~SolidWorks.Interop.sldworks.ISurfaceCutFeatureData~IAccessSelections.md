# IAccessSelections Method (ISurfaceCutFeatureData)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurfaceCutFeatureData~IAccessSelections`
...
*Component*
:   Component in which the surface-cut feature is to be modified
...
- [ISurfaceCutFeatureData::ReleaseSelectionAccess](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurfaceCutFeatureData~ReleaseSelectionAccess.md) if you did not
...
[ISurfaceCutFeatureData::AccessSelections Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurfaceCutFeatureData~AccessSelections.md)
