...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMathTransform~GetData`

Obsolete. See IMathTransform::GetData2.
Obsolete. See [IMathTransform::GetData2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMathTransform~GetData2.md).
