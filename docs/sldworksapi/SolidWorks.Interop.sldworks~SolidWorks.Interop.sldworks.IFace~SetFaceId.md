# SetFaceId Method (IFace)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFace~SetFaceId`

Obsolete. Superseded by IFace2::SetFaceId.
Obsolete. Superseded by [IFace2::SetFaceId](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFace2~SetFaceId.md).
