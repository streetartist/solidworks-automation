# IShutOffSurfaceFeatureData Interface Methods

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IShutOffSurfaceFeatureData_methods`

Allows access to a shut-off surface feature.
For a list of all members of this type, see [IShutOffSurfaceFeatureData members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IShutOffSurfaceFeatureData_members.md).
