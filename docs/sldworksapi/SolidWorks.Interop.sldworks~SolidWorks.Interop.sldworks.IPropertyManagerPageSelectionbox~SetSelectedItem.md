...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPropertyManagerPageSelectionbox~SetSelectedItem`

Sets whether an item is selected or cleared in a selection box enabled for multiple selection.
Sets whether an item is selected or cleared in a [selection box enabled for multiple selection](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPropertyManagerPageSelectionbox~Style.md).
