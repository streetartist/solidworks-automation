...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IEdge~Evaluate2`
...
Use [IEdge::GetCurveParams3](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IEdge~GetCurveParams3.md) to determine the valid range of U parameter values for Parameter.
