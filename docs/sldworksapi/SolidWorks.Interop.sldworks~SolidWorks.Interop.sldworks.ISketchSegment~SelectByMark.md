...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchSegment~SelectByMark`

Obsolete. Superseded by ISketchSegment::Select4.
Obsolete. Superseded by [ISketchSegment::Select4](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchSegment~Select4.md).
