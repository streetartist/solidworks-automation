# GetFeatureManagerTreeTabIndex Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelViewManager~GetFeatureManagerTreeTabIndex`
...
Function GetFeatureManagerTreeTabIndex() As System.Integer
```
...
value = instance.GetFeatureManagerTreeTabIndex()
```

```

System.int GetFeatureManagerTreeTabIndex()
```
