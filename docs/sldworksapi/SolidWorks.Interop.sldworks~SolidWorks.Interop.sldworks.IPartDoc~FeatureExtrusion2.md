# FeatureExtrusion2 Method (IPartDoc)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPartDoc~FeatureExtrusion2`

Obsolete. Superseded by IFeatureManager::FeatureExtrusion2.
Obsolete. Superseded by [IFeatureManager::FeatureExtrusion2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~FeatureExtrusion2.md).
...
instance.FeatureExtrusion2(Sd, Flip, Dir, T1, T2, D1, D2, Dchk1, Dchk2, Ddir1, Ddir2, Dang1, Dang2, OffsetReverse1, OffsetReverse2, Merge)
```

```

void FeatureExtrusion2( 
   System.bool Sd,
   System.bool Flip,
   System.bool Dir,
   System.int T1,
