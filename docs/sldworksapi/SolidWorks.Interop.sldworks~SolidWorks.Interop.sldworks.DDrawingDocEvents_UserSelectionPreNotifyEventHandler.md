# DDrawingDocEvents_UserSelectionPreNotifyEventHandler Delegate

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.DDrawingDocEvents_UserSelectionPreNotifyEventHandler`
...
Public Delegate Function DDrawingDocEvents_UserSelectionPreNotifyEventHandler( _
...
Dim instance As New DDrawingDocEvents_UserSelectionPreNotifyEventHandler(AddressOf HandlerMethod)
```

```

public delegate System.int DDrawingDocEvents_UserSelectionPreNotifyEventHandler( 
   System.int SelType
)
```
...
If developing a C++ application, use [swDrawingUserSelectionPreNotify](ms-help://SolidWorks.Interop.swconst/SolidWorks/SOLIDWORKS.Interop.swconst~SOLIDWORKS.Interop.swconst.swDrawingNotify_e.html) to register for this notification.
...
[DDrawingDocEvents\_UserSelectionPreNotifyEventHandler Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.DDrawingDocEvents_UserSelectionPreNotifyEventHandler.md)  
