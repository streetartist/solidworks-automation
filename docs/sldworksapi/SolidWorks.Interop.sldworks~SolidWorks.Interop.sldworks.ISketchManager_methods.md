...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager_methods`

Provides access to sketch-creation routines.
For a list of all members of this type, see [ISketchManager members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager_members.md).
