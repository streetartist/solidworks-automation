...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICountersinkElementData`
...
Public Interface ICountersinkElementData 
```
...
public interface class ICountersinkElementData 
```
