# IAccessSelections Method (ISurfacePlanarFeatureData)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurfacePlanarFeatureData~IAccessSelections`
...
- [ISurfacePlanarFeatureData::ReleaseSelectionAccess](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurfacePlanarFeatureData~ReleaseSelectionAccess.md) if you did not
...
[ISurfacePlanarFeatureData::AccessSelections Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurfacePlanarFeatureData~AccessSelections.md)
