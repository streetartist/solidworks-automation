# IsBossFeature Method (IExtrudeFeatureData2)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IExtrudeFeatureData2~IsBossFeature`
...
True if this extrusion is a boss feature, false if not
