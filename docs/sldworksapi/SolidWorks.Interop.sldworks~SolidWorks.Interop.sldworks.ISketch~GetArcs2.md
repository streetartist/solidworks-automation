...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketch~GetArcs2`
...
To determine the number of arcs, use [ISketch::GetArcCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketch~GetArcCount.md).
...
[ISketch::IGetArcs2 Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketch~IGetArcs2.md)  
