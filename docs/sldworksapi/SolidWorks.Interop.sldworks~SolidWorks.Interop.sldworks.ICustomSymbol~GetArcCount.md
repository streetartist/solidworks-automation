# GetArcCount Method (ICustomSymbol)

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICustomSymbol~GetArcCount`

Obsolete. Superseded by INote::GetArcCount.
Obsolete. Superseded by [INote::GetArcCount](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.INote~GetArcCount.md).
