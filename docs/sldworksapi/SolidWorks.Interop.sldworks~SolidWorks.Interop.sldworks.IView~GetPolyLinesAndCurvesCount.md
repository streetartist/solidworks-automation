...
Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetPolyLinesAndCurvesCount`
...
*PointCount*
:   Size of array to allocate in doubles for [IView::IGetPolyLinesAndCurves](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~IGetPolyLinesAndCurves.md)
...
Call this method before calling [IView::IGetPolyLinesAndCurves](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~IGetPolyLinesAndCurves.md).
...
[IView::IGetPolylines6 Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~IGetPolylines6.md)
