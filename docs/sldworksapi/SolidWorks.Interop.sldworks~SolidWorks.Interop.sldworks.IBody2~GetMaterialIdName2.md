# GetMaterialIdName2 Method

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~GetMaterialIdName2`
...
Function GetMaterialIdName2() As System.String
```
...
value = instance.GetMaterialIdName2()
```

```

System.string GetMaterialIdName2()
```
