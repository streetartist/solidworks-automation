# IMacroFeatureData Interface Methods

Help ID: `SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData_methods`

Allows access to the data that defines a macro feature.
For a list of all members of this type, see [IMacroFeatureData members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData_members.md).
